# Harn-LLM Tester 启动指南

## 启动方式

Harn-LLM Tester 提供两种启动方式：
...
║           ╚═╝   ╚══════╝╚══════╝   ╚═╝   ╚══════╝╚═╝  ╚═╝             ║
║                                                                       ║
║               General Agent, LLM, Harness & File Testing              ║
║                                                                       ║
╚═══════════════════════════════════════════════════════════════════════╝
...
============================================================
  🚀 Starting Harn-LLM Tester Server...
============================================================
  Platform:     MACOS
...
Harn-LLM Tester - General Agent, LLM, Harness & File Testing
